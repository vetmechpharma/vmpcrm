...
# This provides a comprehensive list of Indian states/UTs and their districts

INDIAN_STATES_DISTRICTS = {
    "Andhra Pradesh": [
        "Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna", "Kurnool",
        "Nellore", "Prakasam", "Srikakulam", "Visakhapatnam", "Vizianagaram",
        "West Godavari", "YSR Kadapa", "Palnadu", "Bapatla", "Eluru", "Kakinada",
        "Anakapalli", "Konaseema", "Alluri Sitharama Raju", "NTR", "Sri Sathya Sai",
        "Annamayya", "Tirupati", "Nandyal"
    ],
    "Arunachal Pradesh": [
    ...
    "Madhya Pradesh": [
        ...
        "Singrauli", "Tikamgarh", "Ujjain", "Umaria", "Vidisha", "Niwari", "Maihar"
    ],
    "Maharashtra": [
...
def get_all_states():
    ...
    return sorted(INDIAN_STATES_DISTRICTS.keys())

def get_districts_by_state(state: str):
    """Get list of districts for a given state"""
    return sorted(INDIAN_STATES_DISTRICTS.get(state, []))
