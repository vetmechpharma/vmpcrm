...
@api_router.get("/greeting-templates")
...
@api_router.post("/greeting-templates")
...
@api_router.put("/greeting-templates/{template_id}")
...
@api_router.delete("/greeting-templates/{template_id}")
...
@api_router.post("/greeting-templates/test-send")
