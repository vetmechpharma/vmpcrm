            ...
            for log in batch:
                try:
                    ...
                    if campaign.get('has_image', False):
                        image_url_to_send = f"https://crm-distribution-hub.preview.emergentagent.com/api/marketing/campaigns/{campaign_id}/image"
                    # For product promotions, use first item's image as default
                        ...
                        for item in campaign['item_details']:
                            if item.get('has_image'):
                                image_url_to_send = f"https://crm-distribution-hub.preview.emergentagent.com/api/items/{item['id']}/image"
                                break
